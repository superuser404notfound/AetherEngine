...
```swift
.package(url: "https://github.com/superuser404notfound/AetherEngine", from: "3.13.6")
```
...
Pin to `.upToNextMinor(from: "3.13.6")` for stricter teams that prefer to opt into minor bumps explicitly.
