...
```swift
.package(url: "https://github.com/superuser404notfound/AetherEngine", from: "7.18.1")
```
...
Pin to `.upToNextMinor(from: "7.18.1")` for stricter teams that prefer to opt into minor bumps explicitly.
